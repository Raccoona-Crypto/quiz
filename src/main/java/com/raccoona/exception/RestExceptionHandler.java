package com.raccoona.exception;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNotFound(final NotFoundException e, final WebRequest request) {
        return handleExceptionInternal(e, new ErrorResponse(e.getMessage(), HttpStatus.NOT_FOUND),
                new HttpHeaders(), HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler({AlreadyExistsException.class})
    public ResponseEntity<Object> handleBadRequest(final AlreadyExistsException e, final WebRequest request) {
